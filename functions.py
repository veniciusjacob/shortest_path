...
# essa função recebe um endereço e um cliente do Google Maps, realiza a geocodificação desse endereço usando o cliente fornecido e retorna as coordenadas geográficas correspondentes.
...
#esta função encontra e retorna o caminho mais curto entre os nós de origem e destino no grafo de ruas, utilizando o algoritmo A*.
